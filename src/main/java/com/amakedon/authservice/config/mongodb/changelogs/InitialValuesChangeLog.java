package com.amakedon.authservice.config.mongodb.changelogs;

import com.amakedon.authservice.domain.AuthClientDetails;
import com.amakedon.authservice.domain.User;
import com.amakedon.authservice.enums.Authorities;
...
public class InitialValuesChangeLog {
    ...
    @ChangeSet(order = "001", id = "insertBrowserClientDetails", author = "amakedon")
    ...
    @ChangeSet(order = "002", id = "insertUserToTestAuthentication", author = "amakedon")
